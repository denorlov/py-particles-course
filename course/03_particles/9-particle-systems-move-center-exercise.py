# Make the origin point move dynamically. Use the concepts of velocity and
# acceleration to make the system move autonomously.

# 1) Реализуйте систему частиц, так чтобы ее центр двигался с определенной
# заданной скоростью и ускорением.
# 2) Реализуйте создание новой системы частиц при нажатии на кнопку мыши, в точке курсора мыши
