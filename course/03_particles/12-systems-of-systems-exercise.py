...
# Реализуйте симуляцию обьекта, который взрывается и разлетается на мелкие клочки.
# Подумайте, как можно реализовать разделение одной большой фигуры на много маленьких частей?
# Что если на экране несколько больших фигур, каждая из которых взрывается и
# рассыпается на осколки, когда по ней кликают мышкой?
