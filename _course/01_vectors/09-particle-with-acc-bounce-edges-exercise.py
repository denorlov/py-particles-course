# модифицируйте программу с шарами движущимися с постоянным ускорением,
# так что шар долетевший до границы экрана отражается от границы экрана
# при этом он меняет направление своего движения, но сохраняет скорость и ускорение
