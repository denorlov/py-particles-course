...
# Реализуйте систему частиц, в которой присутсвтуют разные типы частиц.
# Попробуйте реализовать разное поведение для разных типов частиц, а не только разное отображение.
