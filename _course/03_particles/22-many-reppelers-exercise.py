# Expand the above example to include many repellers (using list).
# Дополните предыдущую работу. Реализуйте не один Reppeler а несколько (стоит использовать список)
