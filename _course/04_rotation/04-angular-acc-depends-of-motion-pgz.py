...
class Particle:
    ...
    def draw(self):
        x, y = rotate((self.pos.x, self.pos.y), (self.pos.x, self.pos.y + 20), math.radians(self.angle))
        x1, y1 = rotate((self.pos.x, self.pos.y), (self.pos.x, self.pos.y - 20), math.radians(self.angle))
